...
/*1. Navigate to https://www.mediacollege.com/internet/samples/html/country-list.html.
        ...
        4. Check the entire dropdown and create a new list that contains all the
...
public class PracticeDropdown extends TestBase {
    ...
    public void verifyDefaultValue() {
        ...
        Assert.assertTrue(isFranceOnTheList, "France is not on the list");
        ...
        Assert.assertEquals(7, listOfCountriesThatStartsWithZ.size(), "The size of the list is not correct");
